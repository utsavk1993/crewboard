    ...
    <header className="sticky top-0 z-40 border-b bg-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="mx-auto flex h-14 w-full max-w-7xl items-center justify-between gap-4 px-4 sm:px-6">
        <div className="flex min-w-0 items-center gap-2.5">
          {/* Negative margin offsets the padding so the focus ring has room without shifting the layout. */}
          <Link
            to="/"
            aria-label="Crewboard home"
            className="-m-1 flex min-w-0 items-center gap-2.5 rounded-lg p-1 outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50"
          >
